...
//璁块棶杩欎簺瀵勫瓨鍣?闇€鍏堝皢EAXFR璁剧疆涓?,鎵嶅彲姝ｅ父璇诲啓
//    EAXFR = 1;
//鎴栬€?
//    P_SW2 |= 0x80;
///////////////////////////////////////////////////
...
#define	EAXSFR()		EAXFR = 1		/* MOVX A,@DPTR/MOVX @DPTR,A鎸囦护鐨勬搷浣滃?硅薄涓烘墿灞昐FR(XSFR) */
#define	EAXRAM()		EAXFR = 0		/* MOVX A,@DPTR/MOVX @DPTR,A鎸囦护鐨勬搷浣滃?硅薄涓烘墿灞昍AM(XRAM) */
