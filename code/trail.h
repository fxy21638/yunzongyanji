...
#define HUANDAO_ENABLE        1   /* 1=启用环岛检测, 0=跳过环岛 */

/* TRACK_ELEMENT (保持兼容 track_fsm.h) */
typedef enum {
    NONE, START, STRAIGHT, RIGHT_ANGLE_l, RIGHT_ANGLE_r,
...
#define DOWN_JUMP_TH         6
#define DOWN_STABLE_TH       7
#define CROSS_STABLE_TH      7
...
/* 靶子状态 */
typedef enum {
    TARGET_WAIT_FAR = 0, TARGET_TRACK_FAR = 1,
    TARGET_TRACK_NEAR = 2, TARGET_FIRE = 3
} target_state_e;
