...
static const track_fsm_cfg_t s_default_cfg[TRACK_FSM_CFG_COUNT] =
{
	...
	/* STRAIGHT 直道 */     {0.42f,0.00f,0.25f,0.0f, 0.30f,0.02f,0.45f,2.0f, 0.20f,0.65f, PLAN_STRAIGHT,   1.0f, 2},
	/* RIGHT_ANGLE_l 左弯 */{0.45f,0.08f,0.45f,8.0f, 0.20f,0.06f,0.55f,6.0f, 0.10f,0.65f, PLAN_TURN_LEFT,  0.55f,5},
	/* RIGHT_ANGLE_r 右弯 */{0.45f,0.08f,0.45f,8.0f, 0.20f,0.06f,0.55f,6.0f, 0.10f,0.65f, PLAN_TURN_RIGHT, 0.55f,5},
